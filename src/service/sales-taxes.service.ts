...
var html = fs.readFileSync("salestax.html", "utf8");

@Injectable()
export class SalesTaxService {
	constructor(@InjectRepository(Salestaxesandtemplates001mb) private readonly salestaxRepository: Repository<Salestaxesandtemplates001mb>,) { }
