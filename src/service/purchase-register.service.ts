...
var html = fs.readFileSync("purchaseRegister.html", "utf8");

@Injectable()
export class PurchaseRegisterService {
    constructor(@InjectRepository(Purchaseregister001mb) private readonly purchaseRegisterRepository: Repository<Purchaseregister001mb>,) { }
