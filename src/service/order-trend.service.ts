...
var html = fs.readFileSync("order-trend.html", "utf8");

@Injectable()

export class OrderTrendService {

    constructor(@InjectRepository(Delnotetrends001mb) private readonly orderRepository: Repository<Delnotetrends001mb>) { }
    ...
    async update(delnotetrendsDTO: DelnotetrendsDTO): Promise<Delnotetrends001mb> {
        const delnotetrends001mb = new Delnotetrends001mb();
        delnotetrends001mb.setProperties(delnotetrendsDTO);
        await this.orderRepository.update({ dntrendId: delnotetrends001mb.dntrendId }, delnotetrends001mb);
