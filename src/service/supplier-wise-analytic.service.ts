...
var html = fs.readFileSync("supplierWise.html", "utf8");

@Injectable()

export class SupplierWiseAnalyticService {

    constructor (@InjectRepository(Swsanalytics001mb) private readonly supplierAnalyticRepository: Repository<Swsanalytics001mb>) {}
