...
var html = fs.readFileSync("purchase-order.html", "utf8");

@Injectable()
export class PurchaseOrderService {
	constructor(@InjectRepository(Prpurchaseord001mb) private readonly purchaseOrderpRepository: Repository<Prpurchaseord001mb>) { }
	...
	async update(prpurchaseordDTO: PrpurchaseordDTO): Promise<Prpurchaseord001mb> {
		const prpurchaseord001mb= new Prpurchaseord001mb();
        prpurchaseord001mb.setProperties(prpurchaseordDTO);
		await this.purchaseOrderpRepository.update({proId: prpurchaseord001mb. proId }, prpurchaseord001mb);
