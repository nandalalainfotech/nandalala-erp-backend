...
var html = fs.readFileSync("landcost.html", "utf8");

@Injectable()
export class ToolsLandCostService {
    constructor(@InjectRepository(Landcostvouch001mb) private readonly landcostRepository: Repository<Landcostvouch001mb>,) { }
