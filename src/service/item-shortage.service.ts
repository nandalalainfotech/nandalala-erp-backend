...
var html = fs.readFileSync("itemShortage.html", "utf8");

@Injectable()
export class ItemShortageService {
	constructor(@InjectRepository(Itemshortagerep001mb) private readonly itemShortageRepository: Repository<Itemshortagerep001mb>) { }

	async create(itemshortagerepDTO:ItemshortagerepDTO): Promise<Itemshortagerep001mb> {
	...
	async update(itemshortagerepDTO:ItemshortagerepDTO): Promise<Itemshortagerep001mb> {
		const itemshortagerep001mb= new Itemshortagerep001mb();
        itemshortagerep001mb.setProperties(itemshortagerepDTO);
		await this.itemShortageRepository.update({shrepId:itemshortagerep001mb.shrepId},itemshortagerep001mb);
