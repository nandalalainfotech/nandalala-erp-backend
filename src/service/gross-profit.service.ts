...
var html = fs.readFileSync("grossProfit.html", "utf8");

@Injectable()
export class GrossProfitService {
    constructor(@InjectRepository(Grossprofit001mb) private readonly grossProfitRepository: Repository<Grossprofit001mb>) { }
    ...
    async update(grossprofitDTO: GrossprofitDTO): Promise<Grossprofit001mb> {
        const grossprofit001mb = new Grossprofit001mb();
        grossprofit001mb.setProperties(grossprofitDTO);
        await this.grossProfitRepository.update({ id: grossprofit001mb.id }, grossprofit001mb);
