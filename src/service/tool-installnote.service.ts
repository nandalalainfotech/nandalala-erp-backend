...
var html = fs.readFileSync("installnote.html", "utf8");

@Injectable()
export class ToolsInstallNoteService {
	constructor(@InjectRepository(Instalnote001mb) private readonly installnoteRepository: Repository<Instalnote001mb>,) { }
