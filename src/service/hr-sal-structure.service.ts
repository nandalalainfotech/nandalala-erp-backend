...
var html = fs.readFileSync("salstructure.html", "utf8");


@Injectable()
export class HrSalaryStructureService {
	constructor(@InjectRepository(Salarystructure001mb) private readonly salstructureRepository: Repository<Salarystructure001mb>,) { }

	async create(salarystructureDTO: SalarystructureDTO): Promise<Salarystructure001mb> {
	...
	async update(salarystructureDTO: SalarystructureDTO): Promise<Salarystructure001mb> {
		const salarystructure001mb = new Salarystructure001mb();
		salarystructure001mb.setProperties(salarystructureDTO);
		await this.salstructureRepository.update({ strId: salarystructure001mb.strId }, salarystructure001mb);
