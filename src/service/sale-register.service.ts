...
var html = fs.readFileSync("salesRegister.html", "utf8");

@Injectable()
export class SalesRegisterService {
    constructor(@InjectRepository(Salesregister001mb) private readonly salesRegisterRepository: Repository<Salesregister001mb>,) { }
