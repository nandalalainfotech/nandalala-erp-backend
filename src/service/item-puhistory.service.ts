...
var html = fs.readFileSync("item-puhistory.html", "utf8");

@Injectable()
export class ItemPuhistoryService {
    constructor(@InjectRepository(Itempuhist001mb) private readonly itemPuhistoryRepository: Repository<Itempuhist001mb>) { }
    ...
    async update(itempuhistDTO: ItempuhistDTO): Promise<Itempuhist001mb> {
        const itempuhist001mb = new Itempuhist001mb();
        itempuhist001mb.setProperties(itempuhistDTO);
        await this.itemPuhistoryRepository.update({ histId: itempuhist001mb.histId }, itempuhist001mb);
