...
var html = fs.readFileSync("periodclosingVoucher.html", "utf8");


@Injectable()
export class PeriodclosingVoucherService {
    constructor(@InjectRepository(Periodclosingvoucher001mb) private readonly periodclosingVoucherRepository: Repository<Periodclosingvoucher001mb>) { }
