...
var html = fs.readFileSync("stockBalance.html", "utf8");

@Injectable()
export class StockBalanceService {
    constructor(@InjectRepository(Stkrepbalance001mb) private readonly stockBalanceRepository: Repository<Stkrepbalance001mb>,) { }
