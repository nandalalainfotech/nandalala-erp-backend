...
var html = fs.readFileSync("journalentry.html", "utf8");

@Injectable()
export class JournalEntryService {
    constructor(@InjectRepository(Jounalentry001mb) private readonly journalentryRepository: Repository<Jounalentry001mb>,) { }
    ...
    async update(jounalEntryDTO: JounalentryDTO): Promise<Jounalentry001mb> {
        const jounalentry001mb = new Jounalentry001mb();
        jounalentry001mb.setProperties(jounalEntryDTO);
        await this.journalentryRepository.update({ jeId: jounalentry001mb.jeId }, jounalentry001mb);
