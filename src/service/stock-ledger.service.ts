...
var html = fs.readFileSync("stockLedger.html", "utf8");

@Injectable()
export class StockLedgerService {
    constructor(@InjectRepository(Stkrepledger001mb) private readonly stockLedgerRepository: Repository<Stkrepledger001mb>,) { }
