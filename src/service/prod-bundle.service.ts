...
var html = fs.readFileSync("prod-bundle.html", "utf8");

@Injectable()
export class ProdBundleService {
    constructor(@InjectRepository(Prodbundle001mb) private readonly prodbundleRepository: Repository<Prodbundle001mb>,) { }
