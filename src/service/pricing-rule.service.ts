...
var html = fs.readFileSync("pricing-rule.html", "utf8");


@Injectable()
export class PricingRuleService {
	constructor(@InjectRepository(Pricingrule001mb) private readonly pricingRuleRepository: Repository<Pricingrule001mb>,) { }
